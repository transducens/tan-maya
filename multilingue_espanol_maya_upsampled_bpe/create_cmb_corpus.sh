...
echo "Antes de hacer upsampling hay $(wc cmb/train/data.es -l) oraciones"
...
echo "Después de hacer upsampling hay $(wc cmb/train/data.es -l) oraciones"
# Extract language tokens from training dataset
cut -d " " -f1 cmb/train/data.cmb > cmb/train/lang_tokens
