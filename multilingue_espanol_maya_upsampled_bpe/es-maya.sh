...
#cut cmb/train/data.es -d '#' -f3 > cmb/train/data.notoken
#cut cmb/train/data.es -d '#' -f2 > cmb/train/lang_tokens_main
#
#cut cmb/train/data.es.upsampled -d '#' -f3 > cmb/train/data.es.upsampled.notoken
#cut cmb/train/data.cmb.upsampled -d '#' -f3 > cmb/train/data.cmb.upsampled.notoken
#
#mv cmb/train/data.notoken cmb/train/data.es
#mv cmb/train/data.es.upsampled.notoken cmb/train/data.es.upsampled
#mv cmb/train/data.cmb.upsampled.notoken cmb/train/data.cmb.upsampled
#
...
#paste -d '#' cmb/train/lang_tokens_main cmb/train/data.bpe.es | sed "s/^/#/" > cmb/train/data.langtoken
#mv cmb/train/data.langtoken cmb/train/data.bpe.es
#
#sed -i "s/^/ /" cmb/train/data.es 
#paste -d '#' cmb/train/lang_tokens_main cmb/train/data.es | sed "s/^/#/" > cmb/train/data.langtoken
#mv cmb/train/data.langtoken cmb/train/data.es
#
#rm cmb/train/lang_tokens_main
#
#echo "Detaching lang tokens from dev set"
#cut cmb/dev/data.es -d '#' -f3 > cmb/dev/data.notoken
...
#paste -d '#' cmb/dev/lang_tokens cmb/dev/data.bpe.es | sed "s/^/#/" > cmb/dev/data.langtoken
...
#		cut cmb/test/$lang/data.es -d '#' -f3 > cmb/test/$lang/data.notoken
...
#		paste -d '#' cmb/test/$lang/lang_tokens cmb/test/$lang/data.bpe.es | sed "s/^/#/" > cmb/test/$lang/data.langtoken
